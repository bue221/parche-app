  ...
  ),
  {
    variants: {
      variant: {
        ...
        subheading: 'text-subheading font-normal',
        headingSm: 'text-heading-sm font-bold',
        heading: 'text-heading font-bold',
        display: 'font-foggy text-display font-normal leading-[0.83] tracking-normal',
        h1: 'font-foggy text-display font-normal leading-[0.83] tracking-normal',
        h2: 'text-heading font-bold',
        h3: 'text-heading-sm font-bold',
        h4: 'text-subheading font-bold',
        p: 'text-body font-normal',
